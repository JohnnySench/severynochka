...
<template>
  <header class="header">
    <Container class="header_container">
      <Logo :bg-color="'white'" colorful :orientation="'horizontal'" with-text/>
      ...
      <div class="header_search">
        <Field v-model="searchField" placeholder="Найти товар" size="m" :on-submit="onSubmit">
          <template #rightIcon>
      ...
      <div class="header_user-menu">
        ...
        <Button v-else color="primary" class="header_login-btn">
          <template #default>
            Войти
          </template>
          <template #rightIcon>
